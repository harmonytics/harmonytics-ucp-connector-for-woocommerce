...
class UCP_WC_Category_Controller extends UCP_WC_REST_Controller {
				...
				array(
					...
					'args'                => array(
						'category_id' => array(
							'required'          => true,
							'type'              => 'integer',
							'description'       => __( 'Category ID.', 'ucp-for-woocommerce' ),
	...
	private function get_list_categories_args() {
		return array(
			...
			'parent'     => array(
				'required'          => false,
				'type'              => 'integer',
				'description'       => __( 'Filter by parent category ID. Use 0 for top-level categories only.', 'ucp-for-woocommerce' ),
			...
			'hide_empty' => array(
				...
				'type'        => 'boolean',
				'default'     => false,
				'description' => __( 'Hide empty categories.', 'ucp-for-woocommerce' ),
			),
			'orderby'    => array(
				'required'    => false,
				'type'        => 'string',
			...
			'hierarchy'  => array(
				...
				'type'        => 'boolean',
				'default'     => false,
				'description' => __( 'Return categories as a hierarchical tree.', 'ucp-for-woocommerce' ),
			),
		);
	}
	...
	private function get_category_products_args() {
		return array(
			...
			'include_children' => array(
				...
				'type'        => 'boolean',
				'default'     => true,
				'description' => __( 'Include products from child categories.', 'ucp-for-woocommerce' ),
			),
			'orderby'         => array(
				'required'    => false,
				'type'        => 'string',
	...
	public function list_categories( $request ) {
		...
		if ( is_wp_error( $terms ) ) {
			return $this->error_response(
				...
				__( 'Failed to retrieve categories.', 'ucp-for-woocommerce' ),
				500
			);
		}
	...
	public function get_category( $request ) {
		...
		if ( ! $term || is_wp_error( $term ) ) {
			return $this->error_response(
				'category_not_found',
				__( 'Category not found.', 'ucp-for-woocommerce' ),
				404
			);
		}
